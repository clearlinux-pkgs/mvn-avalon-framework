...
License  : Apache-1.1
Requires: mvn-avalon-framework-data = %{version}-%{release}

%description
No detailed description available

%package data
Summary: data components for the mvn-avalon-framework package.
Group: Data

%description data
data components for the mvn-avalon-framework package.
